...
$pro_id = $row_products['product_id'];// Cette ligne extrait la valeur de la colonne 'product_id' de la ligne actuelle de résultats et la stocke dans la variable $pro_id.
