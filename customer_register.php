...
<?php
// Cette ligne vérifie si le champ "register" a été soumis dans le formulaire. Si tel est le cas, le code à l'intérieur du bloc conditionnel sera exécuté.
if(isset($_POST['register'])){
$remoteip = $_SERVER['REMOTE_ADDR'];
if($result['success'] == 0){

$c_name = $_POST['c_name']; //récupérer les données soumises dans un formulaire avec un champ nommé "c_name
...
$customer_confirm_code = mt_rand(); //est une fonction native de PHP qui génère un nombre aléatoire
...
$headers .= "Content-type: text/html\r\n";//utilisée pour indiquer un retour à la ligne, ce qui est nécessaire pour séparer les en-têtes dans un e-mail.
...
echo "<script>alert('Please Select , Try Again')</script>";
