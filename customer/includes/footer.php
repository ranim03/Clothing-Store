	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Avenue 5100.<br>
				Mahdia Tunisie
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:21236484">21236484</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@clothingstore.com" class="email__addr">support@clothingstore.com</a>
				</div>
			</div>
