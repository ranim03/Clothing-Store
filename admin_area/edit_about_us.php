...
if(isset($_POST['submit'])){
 //vérifie si un formulaire a été soumis via la méthode POST, en cherchant un champ nommé 'submit'. Si tel est le cas,
 // il récupère la valeur du champ 'about_heading' envoyé dans le formulaire et la stocke dans la variable $about_heading.
